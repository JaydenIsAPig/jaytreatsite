(function (window) {
  ...
  const siteConfig = {
    ...
    emailSignup: {
      ...
      endpoint: "",
      successMessage: "Thank you. You are on the Jewelry list.",
    ...
    text: {
      ...
      aboutEyebrow: "A word from Jayden",
      ...
      aboutContactLabel: "Click here to Contact me",
