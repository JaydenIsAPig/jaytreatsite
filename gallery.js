...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (featuredContainer && typeof currentTreatID !== 'undefined') {
        ...
        if (featuredTreat) {
            ...
            if (heroImage) {
                // Home page image with overlaid text
                visualHTML = 
                ...
                if (treat.name.toLowerCase().includes(cleanFilter) || 
                    ...
                    const cardHTML = 
                        '<div class="content-block animate-in" style="margin-bottom: 40px;">' +
                            ...
                            '</a>' +
                            '<div class="card-text">' +
                                // UPDATED: Removed underline, kept white text so outline pops
